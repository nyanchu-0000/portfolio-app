                        ...
                        <div className="mb-16">
                            <div className="bg-cream-50 rounded-lg p-8 shadow-lg border border-sand-200">
                                ...
                                <p className="text-brown-700 mb-6 leading-relaxed">
                                    ...
                                    既存のSNSアプリでは、不特定多数との繋がりになることが多いが、本来「見せたい・見たい人」は僅かなのでは？という点から着想を得て開発しました。また、承認欲求を満たしたいという理由でSNSを利用するユーザーが増えていることから、「いいね」の代わりに承認ボタンを設置し、投稿を承認しあうことができる承認欲求を満たすアプリです。
                                </p>
